    ...
    public static class DbSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Category>().HasData(
                new Category {Id = 1, CategoryName = "Juice"},
                new Category {Id = 2, CategoryName = "Water"},
                new Category {Id = 3, CategoryName = "Soda"},
                new Category {Id = 4, CategoryName = "Beer"},
                new Category {Id = 5, CategoryName = "Wine"},
                new Category {Id = 6, CategoryName = "Whiskey"}
            );
            ...
            modelBuilder.Entity<Supplier>().HasData(
                new Supplier{ Id=1, CompanyName = "Mason company" },
                new Supplier{ Id=2, CompanyName = "Hudson warehouse" },
                new Supplier{ Id=3, CompanyName = "Woods storage" },
                new Supplier{ Id=4, CompanyName = "Bowman delivery" }
            );
